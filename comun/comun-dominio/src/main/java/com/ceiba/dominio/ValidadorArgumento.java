...
public class ValidadorArgumento {
    ...
    public static void validarMenorMayor(int campo, Long mayorIgualA, Long menorIgualA, String mensaje) {
        if (campo < mayorIgualA || campo >menorIgualA) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }

    public static void validadLongitud(String campo, int minLongitud, int maxLongitud, String mensaje) {
        String regex = "^.{" + minLongitud + "," + maxLongitud + "}$";
